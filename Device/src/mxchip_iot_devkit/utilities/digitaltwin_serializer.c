...
bool Position_SerializeLocationTelemetry(char * payloadBuffer, int size)
{
    ...
    Position_Telemetry_ReadLocation(&location);

    JSON_Value *root_value = json_value_init_object();
    JSON_Object *root_object = json_value_get_object(root_value);

    json_object_set_number(root_object, "lat", location.lat);
    json_object_set_number(root_object, "lon", location.lon);
    json_object_set_number(root_object, "alt", location.alt);
